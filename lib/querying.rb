...
def select_name_and_motto_of_char_with_longest_motto	def select_name_and_motto_of_char_with_longest_motto
  "SELECT name, motto
  FROM characters
...
def select_character_names_and_number_of_books_they_are_in	def select_character_names_and_number_of_books_they_are_in
